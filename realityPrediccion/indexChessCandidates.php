...
<head>
    ...
    <link rel="stylesheet" href="css/styles.css">
       ...
       <style type="text/css">
            .bgimg {
                background-image: url('img/torneoCandidatos2.jpg');
                color: white;
            }
            a:link, a:visited {
            color: white;
...
<script type="text/javascript">
           function cambiarIdioma( elIdioma ){
                //alert(' por aki ');    
                if( elIdioma === 'ingles' ){
                    document.getElementById('idMisPredicciones').innerHTML= "My predictions";
                    document.getElementById('idTodasLasPredicciones').innerHTML= "All predictions";
                    document.getElementById('logout').innerHTML= "logout";
                } else if( elIdioma == 'espanol') {
                    document.getElementById('idMisPredicciones').innerHTML= "Mis predicciones";
                    document.getElementById('idTodasLasPredicciones').innerHTML= "Todas las predicciones";
                    document.getElementById('logout').innerHTML= "Cerrar sessión";
                }
            } 
    </script>
    <div class="bgimg">
    ...
    <div >
        <div class="bgimg">
            ...
            <p style="font-size:20px"><a id= "idMisPredicciones" href="misPredicciones.php?idReality=3">Mis predicciones</a></p>
            <p style="font-size:20px"><a id= "idTodasLasPredicciones" href="prediccionesTodos.php?idReality=3">Todas las predicciones</a></p>
            </div>
    </div>
    </div>    
