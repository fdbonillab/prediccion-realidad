    ...
    <?php require_once 'includes/cabecera.php' ?>
        ...
        <script type="text/javascript">
            ...
            function cambiarImagenFamoso(indice){
                ...
                arrPrediccion[indice] = arrElegido[0];
...
<!--
            ...
            <?php
                ...
                $resEliminados = mysqli_query($db,"SELECT id,nombre,descripcion FROM jugador where activo = 0");
                $arrayElim2 = array();
                if ($resEliminados) {
                ...
                if ($res2) {
                    ...
                    while ($row = mysqli_fetch_row($res2)) {
                       ...
                       <?php }?>
                       <td rowspan="2">
                            <?php  $res3 = mysqli_query($db,"SELECT id,nombre,descripcion,activo FROM jugador where activo = 1");
                                    if ($res3) {
                                        $array = array();
                ...
                <tr><td></td><td><button onclick="mostrarModalGuardar()">Guardar</button><td></td></tr>
                <tr><td>&nbsp;</td></tr>
                <tr><td>&nbsp;</td></tr>
                </table>
                <?php
    ...
    ///// FUNCIONES PHP
       function redirect($url) {
        ...
        function getRankingJugador3($id_ranking,$db){
            ...
            $sql = "SELECT id_jugador FROM resultado_evento WHERE id_ranking =$id_ranking ";
