...
<body>
    ...
    <div >
        <div class="bgimg">
            ...
            <p style="font-size:20px"><a href="misPredicciones.php?idReality=2">Mis predicciones</a></p>
            <p style="font-size:20px"><a href="prediccionesTodos.php?idReality=2">Todas las predicciones</a></p>
            </div>
    </div>
    </div>    
